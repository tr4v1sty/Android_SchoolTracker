...
public class DatabaseConnection {
    ...
    public Term createTerm (Term term){
        ...
        long insertId;
        insertId = database.insert(DBHelper.TERM_TABLE, null, values);
    ...
    public Assessment createAssessment(Assessment assessment) {
        ...
        long insertId;
        insertId = database.insert(DBHelper.ASSESSMENTS_TABLE, null, values);
...
//        long id = assessment.getAssessmentId();
    ...
    public List<Course> getCourses(long termId) {
        ...
        selectionArgs = new String[]{Long.toString(termId)};
...
//                course.setCourseMentorEmailTwo(cursor.getString(cursor.getColumnIndex(DatabaseHelper.COURSE_MENTOR_EMAIL_TWO)));
    ...
    public List<Assessment> getAssessments(long courseId) {
        ...
        String[] selectionArgs;
        selectionArgs = new String[]{Long.toString(courseId)};
